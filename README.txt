...
-Choosing to make new or load a file while one is already open will combine them in the work tabs and workspace.

-formatting is not working. Might be a problem with multiple document interfaces, but we'll see.
...
.doc is, of course, a word document file. It is, as of Pre-Alpha 1.0, the only export method possible. 
